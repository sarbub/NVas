document.addEventListener('DOMContentLoaded', function() {
    ...
    .then(function(xml) {
        ...
        if (InfoElement_1) {
            displayInfo(xml, InfoElement_1,0, "aurora");
            displayInfo(xml, InfoElement_2,1, "aurora");
            displayInfo(xml, InfoElement_3,2, "aurora");
            displayInfo(xml, InfoElement_4,3, "aurora");
            displayInfo(xml, InfoElement_5,4, "aurora");
        } else {
...
button_3.addEventListener("click", display_data);
